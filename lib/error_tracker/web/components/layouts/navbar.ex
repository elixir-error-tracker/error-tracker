defmodule ErrorTracker.Web.Layouts.Navbar do
  ...
  def render(assigns) do
    ~H"""
    <nav class="border-zinc-400 bg-zinc-900">
  ...
  def navbar_item(assigns) do
    ...
    <li>
      <a
        href={@to}
        class="whitespace-nowrap flex-0 block py-2 px-3 rounded-lg text-white hover:text-white hover:bg-zinc-700 md:hover:bg-transparent md:border-0 md:hover:text-sky-500"
        {@rest}
      >
